...
import { disasterAwarenessModules } from '../pages/courses/DisasterAwarenessCourse';
import { emergencyModules } from "../pages/courses/EmergencyPreparednessCourse";
import { firstAidModules } from "../pages/courses/FirstAidTrainingCourse";
...
const VideoPlayer = () => {
  ...
  const fetchVideos = useCallback(() => {
    ...
    switch (courseId) {
        ...
        case 'disaster-awareness': // ✅ add this
        moduleData = disasterAwarenessModules;
        break;
       case "emergency-preparedness":
          moduleData = emergencyModules;
          break;
        case "first-aid-training":
          moduleData = firstAidModules;
          break;
